export const REGIONES_COMUNAS: Record<string, string[]> = {
  ...
  "Ñuble": [
    "Chillán", "Chillán Viejo", "Bulnes", "Cobquecura", "Coelemu",
  ...
  "Biobío": [
    ...
    "Talcahuano", "Tomé", "Lebu", "Arauco", "Cañete",
  ...
  "Araucanía": [
    "Temuco", "Padre Las Casas", "Carahue", "Cholchol", "Cunco",
    "Curarrehue", "Freire", "Galvarino", "Gorbea", "Lautaro",
    "Loncoche", "Melipeuco", "Nueva Imperial", "Perquenco", "Pitrufquén",
